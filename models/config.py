...
class VLMConfig:
    ...
    vlm_checkpoint_path: str = "lusxvr/nanoVLM-460M"
    hf_repo_name: str = "A-Mahla"
...
class TrainConfig:
    ...
    train_dataset_path: str = "smolagents/aguvis-stage-1"
    train_dataset_name: tuple[str, ...] = (
        "all",
    )  # ('allava_laion', 'allava_vflan', 'cambrian(filtered)_processed', 'LLaVA_Instruct_150K', 'vision_flan(filtered)') #
